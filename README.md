...
> **Note:** For a high-resolution, interactive version of this diagram with details for specific modules, please visit our **[Official User Flow Documentation Page]([text](https://www.openassets.xyz/how-it-works))**. (<em>Please open the system sitemap on the platform on the apex section.</em>)
