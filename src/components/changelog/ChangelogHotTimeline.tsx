...
export function ChangelogTimeline() {
    const data = [
        {
            title: "Early November 2025",
            content: (
                <div>
                    <p className="text-neutral-800   text-sm md:text-md lg:text-xl font-medium mb-8">
                        Started The Journey Of Open Assets
                    </p>
        ...
        {
            title: "Mid-Late November 2025",
            content: (
                <div>
                    <p className="text-neutral-800   text-sm md:text-md lg:text-xl font-medium mb-8">
                        Planning and formalising the architecture, design and flow.
                    </p>
                    <p className="text-neutral-800   text-xs md:text-sm font-normal mb-8">
                        Defined by prposals, docs, meets and discussions, we came to a build plan.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                        <img
                            src="/Build-3.png"
        ...
        {
            title: "Mid December 2025",
            content: (
                <div>
                    <p className="text-neutral-800   text-sm md:text-md lg:text-xl font-medium mb-8">
                        Initaitng The Build Phase
                    </p>
                    <p className="text-neutral-800   text-xs md:text-sm font-normal mb-8">
                        Contracts, Oracles, Client, Servers, Designs, UX, war on all fornts begun.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                        <img
                            src="/TOA.png"
