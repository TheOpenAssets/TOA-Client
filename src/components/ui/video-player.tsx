...
// Function to detect and convert YouTube URLs to embed format
...
const VideoPlayer = ({ src }: { src: string }) => {
    ...
    // If YouTube, render iframe instead
    if (isYouTube) {
        return (
            <motion.div
                className="relative w-full h-full max-w-7xl mx-auto rounded-xl overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.2)]"
