...
import { PartnerBorrowSection } from './components/PartnerBorrowSection';
import { useCreditData } from './hooks/useCreditData';
import { useBorrowTerms } from './hooks/useBorrowTerms';
...
const BorrowPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<BorrowTab>('direct');
  ...
  const { borrowTerms } = useBorrowTerms(address, isConnected && !!address && availableCredit > 0);
    ...
    <>
      ...
      <div className="min-h-screen min-w-screen bg-transparent">
        ...
        <div className="max-w-[1400px] min-h-[90vh] mx-auto z-50 relative flex flex-col items-center justify-center bg-transparent">
          <div className="w-full max-w-3xl mx-auto text-center bg-transparent">
              ...
              <>
                ...
                {activeTab === 'direct' && (
                  availableCredit > 0 ? (
                    <>
                      {borrowTerms && (
                        <div className="bg-white rounded-xl border border-gray-200 p-4 mb-4 text-left">
                          ...
                          <div className="text-sm text-gray-700 space-y-1">
                            ...
                            <p className="text-gray-500">Standard LTV for this collateral type: 70%</p>
                          </div>
                        </div>
                      )}
                      <UnifiedBorrowModal
                    ...
                    <div className="bg-transparent mt-15 w-[400px] shadow-lg border border-neutral-300 rounded-2xl p-10 mx-auto">
                ...
                {/* Partner Borrow tab */}
                {activeTab === 'partner' && (
                  <PartnerBorrowSection walletAddress={address} positions={creditData?.collateral ?? []} />
                )}
              </>
            )}
          </div>
