...
const PortfolioPage = () => {
  ...
  type PortfolioTab = 'assets' | 'bids' | 'positions' | 'trades' | 'credit';
                  ...
                  <div className="bg-gray-100/50 border border-neutral-200 shadow-lg rounded-xl p-5 mb-6 space-y-5">
                    <div>
                      ...
                      <p className="font-gellix text-xl font-semibold text-foreground">
                        {(parseFloat(selectedAssetForClaim.investorBalance).toFixed(2))/1e6} {selectedAssetForClaim.tokenSymbol}
                      </p>
                    </div>
